...
For each of the aspects mentioned in the sections below, please do the following:

- Check the current situation:
  - What is done, how, and why?
- Discuss:
  - What would you leave as it is, what would you change, or what are the alternatives? And why?
- Then, improve the dataset (or briefly mention the improvements you would make, in case you do not have enough time).
...
Ensure that subfolders and files have unique names within a shared folder, even in case-insensitive ways. It is best practice not to put two files named `hello.txt` and `Hello.txt` in the same folder.
...
- Timestamps should always be given with a leading zero and 'from big to small', e.g. year, month, day of month, hour, minute, second. This recommendation complies with the international format [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) (e.g. "2024-07-31", "2024-07-31T2313"). 
...
- Avoid overly long names (a maximum of 32 characters is suggested). Also, mind also note above about the full path length.
...
::: {.callout-tip collapse="false" icon="true" title="Tas 1.3: (\~ 10 minutes)"}
...
- Are they machine-readable? How easy is it to write a script to read the files?
- Which alternative formats exist? Are they standardized?
:::
...
::: {.callout-note collapse="true" icon="false" title="Examples of recommended formats"}
...
- Time: Which format is used for the date, time of day and time zone?
