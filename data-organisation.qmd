...
Research data is valuable for researchers and forms the basis for their research. Therefore, it is advisable to structure the data well to save time and effort in the daily handling of research data. In this part of the tutorial, we will look closer at organizational aspects of data management, mainly the folder structure, file and folder naming, and file formats. 
...
::: {.callout-tip icon="true" title="Task 3.1: (\~ 5 minutes)"}
...
::: {.callout-tip icon="true" title="Task 3.2: (\~ 10 minutes)"}
...
::: {.callout-tip icon="true" title="Task 3.3: (\~ 10 minutes)"}
...
Please note that the task in this section is optional. You can go through this section if you still have some time left during the tutorial or read it afterwards.
...
::: {.callout-tip icon="true" title="Task 3.4: (\~ 5 minutes)"}
