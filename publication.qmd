...
Publishing data comes with numerous benefits that usually outperform the extra amount of work that is needed. Planning the management of your data in the beginning is however crucial in order to make the most of it. Having well-organized and documented data will not only increase their value for others but also for your futures self, when going back into your data folder e.g., for a revision after a year.  
Sharing research data your own research becomes comprehensible to others. It becomes reproducible and can be verified. This is a central point in the implementation of good scientific practice. Additional benefits are displayed in the graphic.
