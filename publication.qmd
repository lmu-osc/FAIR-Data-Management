...
#LL: Ich habe mal noch einen Abschnitt zu "Sicherheits-Fragen" miteingefügt, weil das Thema bei uns gerade immer wieder auftaucht. Du kannst diesen aber auch gerne rauslassen, falls du das an dieser Stelle nicht angebracht findest. 
:::
...
#LL: Ich würde die 4. weglassen, weil glaub ich klar ist, dass das jeder für sich beantworten muss. Man könnte natürlich noch auf das ROR Verzeichnis (https://ror.org/) verlinken. 
