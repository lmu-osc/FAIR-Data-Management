...
It is important to keep in mind that you can only define usage conditions by assigning licenses for work that "is yours", i.e., that you have the copyright for. This is not always the case for data. Data that result from a significant creative process (as is often the case in the humanities or qualitative social sciences) are more likely covered by copyright while data that result from rather simple measurement processes (as is often the case for natural or quantitative social sciences) are likely not covered. 
...
The Open Researcher and Contributor ID ([ORCID](https://orcid.org/)) provides a unique and persistent identifier that you yourself connect with your professional (scientific) information. This helps to recognize all your work, even when you change your name or it is misspelled, you move on to a new institution etc. Getting an ORCID is free and quick and there are several platforms from grant application to manuscript submission and beyond that allow you to use to log into their system.
...
3. No, he has moved on but he also connected his ORCID profile, which is however not well maintained.
...
2. There is a contact person listed in the meta data with corresponding email address.
...
3. Yes but if it were not, there is no alternative.
...
When searching re3data, most of these criteria are displayed beside the repository, so you can immediately check whether a potential repository fulfills your requirements.
