...
[^2]: Source https://www.cambridge.org/core/services/authors/open-data/data-availability-statements.
...
[^3]: Brettschneider, P., Axtmann, A., Böker, E., & von Suchodoletz, D. (2021): Offene Lizenzen für Forschungsdaten: Rechtliche Bewertung und Praxistauglichkeit verbreiteter Lizenzmodelle, in: O-Bib. Das Offene Bibliotheksjournal 8(3), pp. 1–22, https://doi.org/10.5282/o-bib/5749. \[only in German\]
...
With the emerging requisite of research data being FAIR, a number of tools have been developed that automatically check how FAIR published data are. These tools have been evaluated and a nice overview has been published (c.p. https://zenodo.org/records/7701941). We invite you to play around with these tools, especially the automatic tools [F-uji Tool](https://www.f-uji.net/) and [FAIR enough](https://fair-enough.semanticscience.org/). E.g., you may input your dataset to different tools and look at the output, check whether the output confirms your impression of the dataset's reusability, or find a dataset that has been published in different repositories and see how that influences a tool's output (e.g., https://doi.org/10.5281/zenodo.7298798 vs. https://doi.org/10.17617/3.LLWRWR.
:::
...
Publishing data can be a hassle, especially when it is an unforeseen requirement when actually submitting an article. Planning the management of your data in the beginning is thus crucial in order to benefit most from it. The extra amount of work this may take is well invested, since having well-organized and documented data will not only increase their value for others but also for your futures self, when going back into your data folder e.g., for a revision after a year.  
On the other hand, publishing data comes with numerous benefits:  
...
-   Publishing data on which research results are based (in addition to the 'traditional' scientific articles) will support the credibility, reproducability, and validity of the results. This increases public trust in science.  
