...
-   Find the filled out README template for example 1 [here](example-1-readme-template.md)
:::
...
-   Find the filled out README template for example 2 [here](example-2-readme-template.md)
:::
...
-   Excluding the "METHODOLOGICAL INFORMATION" section, \~10 of the 19 open fields can be filled based on the information collected in task 2.1.
-   Find the filled out README template for example 3 [here](example-3-readme-template.md)
...
-   Find the filled out README template for example 4 [here](example-4-readme-template.md)
:::
