...
-   Find the filled out README template for example 1 [here](readme-templates/readme-example-1.md)
:::
...
-   Find the filled out README template for example 2 [here](readme-templates/readme-example-2.md)
:::
...
-   Excluding the "METHODOLOGICAL INFORMATION" section, \~10 of the 19 open fields can be filled based on the information collected in task 2.1.
-   Find the filled out README template for example 3 [here](readme-templates/readme-example-3.md)
...
-   Find the filled out README template for example 4 [here](readme-templates/readme-example-4.md)
:::
