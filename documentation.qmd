...
## Solution: Example 1 (~10 min)
-   Who created the dataset? 
    + Göckede, Mathias; Reum, Friedemann; Heimann, Martin
-   What do the data files contain?
    + Atmospheric mixing ratios of CO2 and CH4 at Ambarchik, NE Siberia,
    + Tabular data about measurements taken at the meteorological station for each month between August 2014 and December 2017  
-   When was the dataset generated?
    + The data was collected between 2014 - 2017 
...
-   Can this data set be re-used?
    + Yes, under the conditions of the CC BY4.0 License 

:::

:::{.callout-important collapse="true"}
## Solution: Example 2 (~15 min)
-   Who created the dataset?
...
-   When was the dataset generated?\
    ...
    + The dataset was published on Frebruary 12, 2024.
-   Where was the dataset generated?\
    + Not indicated on dataset level. 
-   Why was the dataset generated?\
    + Not indicated on dataset level. 
...
-   Can this dataset be re-used?\
    + The dataset is connected to a Apache License 2.0, which allows the re-use of primarily the scripts according to the the License agreements. 
:::
