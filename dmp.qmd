...
Throughout a project, there are different processing stages regarding data. You can illustrate the process as a life cycle with the following stages[^2]:  
...
A data management plan covers all stages of the research data life cycle. Therefore, one can assign questions to each stage. By addressing these questions, you create an effective DMP. Exemplary questions include:
...
--> Den sprung verstehe ich glaube ich nicht, eigentlich waren wir ja bei safe storage und jetzt geht es um teilen und langzeit Archivierung?
