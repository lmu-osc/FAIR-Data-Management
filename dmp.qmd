...
MK: Ich bin nicht sicher, ob dieser Link so hilfreich ist;) Die Intention finde ich gut, aber vielleicht finden wir einen Link, wo man wirklich direkt auf veröffentlichte DMPs kommt?
...
::: callout-tip
# Task 4: (~20 min)
If you do not yet have a RDMO account, please register now. Either use the [LMU RDMO](https://rdmo.ub.uni-muenchen.de/) (register using your email or ORCID id) or [MPG RDMO](https://rdmo.mpdl.mpg.de/) (MPG login: Shibboleth). Login and create a new project using the **RDMO catalog**. --> for MPDL it is called catalog, but maybe this differs?
