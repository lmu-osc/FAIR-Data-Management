...
We welcome you to the FAIR research data management workshop. This interactive course is centred around the FAIR principles and their practical application in managing your research data efficiently. Learn to manage your data in a way that enhances its value and accessibility for the wider research community. 

When applying Open Science practices, a central concept of data management is the FAIR principles. FAIR is an acronym and encompasses: 
...
Please note that FAIR and open are not synonyms. Not all FAIR data is necessarily open; some datasets fulfil the FAIR principles but are not considered open data. Economic or legal constraints (e.g. patents) may prevent the dataset from being publicly available. For FAIR data, the conditions and ways to access the data must be clearly defined.[^1] 
:::
...
The purpose of this workshop is thus to encourage you to plan the management of your data very early in the course of the project to benefit most from it. The extra amount of work this may take is well invested since having well-organized and documented data will not only increase their value for others but also for your future self, when going back into your data folder e.g., for a revision after a year.
...
It is your job to investigate one of these datasets with a special focus on data organization, documentation, and publication aspects. We will conclude with an introduction to data management plans, a helpful planning tool to comply with the FAIR principles. The topics are accompanied by distinct boxes that are color-coded for their content:
